...
static const char *fonts[]          = { "monospace:size=10", "CascadiaMono:pixelsize=10:antialias=true:autohint=true" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "urxvt", NULL };
static const char *brightnessdown[] = {"brightness.sh", "-d", NULL};
static const char *brightnessup[] = {"brightness.sh", "-i", NULL};
static const char *volumedown[] = {"volume.sh", "-d", NULL};
...
static Key keys[] = {
    ...
    {0,                           XF86AudioMute,          spawn,          {.v = volumemutetoggle } }, 
